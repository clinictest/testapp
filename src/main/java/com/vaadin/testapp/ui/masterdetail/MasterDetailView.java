package com.vaadin.testapp.ui.masterdetail;
...
import com.vaadin.testapp.service.SampleUserService;
...
public class MasterDetailView extends Div {
    ...
    public MasterDetailView(@Autowired SampleUserService sampleUserService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                Optional<User> samplePersonFromBackend = sampleUserService.get(event.getValue().getId().intValue());
        ...
        save.addClickListener(e -> {
            try {
                ...
                sampleUserService.update(this.user);
                clearForm();
                refreshGrid();
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        Component[] fields = new Component[]{firstName, lastName, important};
